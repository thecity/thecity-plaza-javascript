...
TheCityPlaza = {
  ...
  load_page : function(subdomain, page_to_load, options) {
    ...
    if(this.defaults['subdomain'] == null) {
      ...
      this._class_vars['topics_url']  = 'http://'+subdomain+'.'+thecity_domain+'/plaza/topics.json?callback=?';
      this._class_vars['events_url']  = 'http://'+subdomain+'.'+thecity_domain+'/plaza/events.json?callback=?';
      this._class_vars['prayers_url'] = 'http://'+subdomain+'.'+thecity_domain+'/plaza/prayers.json?callback=?';
      this._class_vars['needs_url']   = 'http://'+subdomain+'.'+thecity_domain+'/plaza/needs.json?callback=?';
      this._class_vars['albums_url']  = 'http://'+subdomain+'.'+thecity_domain+'/plaza/albums.json?callback=?';
    }
