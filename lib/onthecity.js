...
OnTheCity = {
  ...
  load_page : function(subdomain, page_to_load, options) {
    ...
    if(this.defaults['subdomain'] == null) {
      ...
      this._class_vars['topics_url']  = 'http://'+subdomain+'.onthecity.org/plaza/topics.json?callback=?';
      this._class_vars['events_url']  = 'http://'+subdomain+'.onthecity.org/plaza/events.json?callback=?';
      this._class_vars['prayers_url'] = 'http://'+subdomain+'.onthecity.org/plaza/prayers.json?callback=?';
      this._class_vars['needs_url']   = 'http://'+subdomain+'.onthecity.org/plaza/needs.json?callback=?';
      this._class_vars['albums_url']  = 'http://'+subdomain+'.onthecity.org/plaza/albums.json?callback=?';
    }
